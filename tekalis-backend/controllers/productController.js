...
// ===============================================
// POST /api/v1/products/bulk — Admin uniquement
// ===============================================
exports.bulkCreateProducts = async (req, res) => {
  try {
    ...
    if (products.length > 500) {
      return res.status(400).json({ success: false, message: "Maximum 500 produits par import" });
    }
    ...
    console.error("❌ Erreur bulkCreateProducts:", error);
    res.status(500).json({ success: false, message: error.message });
  }
};

// ===============================================
// PUT /api/v1/products/:id — Admin uniquement
// ===============================================
...
// ===============================================
// DELETE /api/v1/products/:id — Admin uniquement
// ===============================================
