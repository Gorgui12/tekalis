...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="p-3 border rounded-lg flex flex-col justify-between shadow hover:shadow-lg transition bg-white">
      {/* 📎 Image + détails */}
      <Link to={`/products/${product._id}`} className="flex-1 flex flex-col items-center text-center">
        <img
          src={product.image}
          alt={product.name}
        ...
        <p className="text-blue-600 font-bold mt-1 text-sm sm:text-base">{product.price} CFA</p>
      </Link>
