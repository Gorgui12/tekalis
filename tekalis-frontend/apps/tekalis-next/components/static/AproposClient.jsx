...
const Apropos = () => {
  ...
  return (
    <div className="min-h-screen bg-surface-50 dark:bg-surface-900">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-brand-500 via-orange-600 to-amber-700 text-white py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                <FaHandshake className="text-brand-200" />
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 120" className="w-full h-12 md:h-20 fill-surface-50 dark:fill-surface-900">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-white dark:bg-surface-800 rounded-2xl shadow-card hover:shadow-elevated transition-all duration-300 p-6 text-center transform hover:-translate-y-1"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-brand-500 to-orange-600 mx-auto rounded-full"></div>
            </div>

            <div className="prose dark:prose-invert max-w-none">
              <p className="text-lg text-surface-700 dark:text-surface-300 leading-relaxed mb-6">
                Fondée avec une vision claire, <span className="font-bold text-brand-600 dark:text-brand-400">Tekalis</span> est 
              ...
              <div className="bg-brand-50 dark:bg-brand-900/20 border-l-4 border-brand-500 p-6 rounded-r-lg my-8">
                <p className="text-lg text-surface-800 dark:text-surface-200 font-medium">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative">
              {/* Ligne verticale */}
              <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-brand-500 to-orange-600"></div>
              ...
              {timeline.map((item, index) => (
                ...
                >
                  {/* Point */}
                  <div className="absolute left-8 md:left-1/2 w-4 h-4 bg-brand-500 rounded-full transform -translate-x-2 md:-translate-x-2 ring-4 ring-white dark:ring-surface-900"></div>

                  {/* Content */}
                  <div className={`ml-16 md:ml-0 md:w-5/12 ${index % 2 === 0 ? 'md:mr-auto md:pr-12' : 'md:ml-auto md:pl-12'}`}>
                    <div className="bg-white dark:bg-surface-800 rounded-xl shadow-card hover:shadow-elevated transition-shadow p-6">
      ...
      {/* Notre Mission */}
      <section className="py-16 bg-gradient-to-br from-brand-500 to-orange-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((value, index) => (
                <div
                  key={index}
                  className="bg-surface-50 dark:bg-surface-900 rounded-2xl p-6 hover:shadow-elevated transition-all duration-300 transform hover:-translate-y-2"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-brand-500 to-orange-600 mx-auto rounded-full mb-6"></div>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-12">
              {advantages.map((advantage, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 bg-white dark:bg-surface-800 rounded-xl p-4 shadow-card hover:shadow-elevated transition"
                >
            ...
            <div className="bg-gradient-to-r from-brand-50 to-orange-50 dark:from-brand-900/20 dark:to-orange-900/20 rounded-2xl p-8 text-center">
              <FaLightbulb className="text-5xl text-yellow-500 mx-auto mb-4" />
              <p className="text-xl text-surface-800 dark:text-surface-200 font-medium mb-6">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link href="/products"
                  className="bg-brand-500 hover:bg-brand-600 text-white px-8 py-3 rounded-xl font-semibold transition transform hover:scale-105 inline-flex items-center gap-2 shadow-md hover:shadow-glow"
                >
                  <FaBox />
                  Découvrir nos produits
                </Link>
                <Link href="/contact"
                  className="bg-white dark:bg-surface-800 hover:bg-surface-100 dark:hover:bg-surface-700 text-surface-900 dark:text-white px-8 py-3 rounded-xl font-semibold transition border-2 border-surface-200 dark:border-surface-700 inline-flex items-center gap-2"
                >
                  <FaUsers />
                  Nous contacter
                </Link>
      ...
      {/* CTA Final */}
      <section className="py-16 bg-gradient-to-br from-gray-900 to-brand-900 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/register"
              className="inline-block bg-white text-brand-600 hover:bg-brand-50 px-10 py-4 rounded-xl font-bold text-lg transition transform hover:scale-105 shadow-xl"
            >
